export default function Card({ photoSrc, isFlipped, isMatched, onClick }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* 🎀 ACHTERKANT: Medium roze + GROTERE tekst */}
        <div
        ...
        >
          <span 
            ...
            style={{ 
              fontSize: 'clamp(1.1rem, 4.5vw, 1.9rem)', // ✅ Groter, maar schaalt netjes mee
            }}
          >
            Happy<br/>Birthday!
          </span>
        ...
        >
          ...
          {/* Groen vinkje overlay als het een match is */}
          {isMatched && (
