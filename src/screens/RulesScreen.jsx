  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden flex items-center justify-center">
      ...
      >
        ...
        <div className="relative bg-white/20 backdrop-blur-md border border-white/30 rounded-3xl shadow-2xl self-center"
          ...
          <div className="flex flex-col gap-5">
            {rules.map((rule, i) => (
              <div key={i} className="flex gap-4 items-start text-lg md:text-xl text-white/95">
        ...
        <button
          ...
          flex items-center justify-center ${shake ? 'btn-shake' : ''}`}
        >
          <span className="flex items-center gap-2 md:gap-3">
            <span className="relative left-[3px] md:left-[4px]">Start het spel! 🎉</span>
          </span>
        </button>
      </div>
    </div>
